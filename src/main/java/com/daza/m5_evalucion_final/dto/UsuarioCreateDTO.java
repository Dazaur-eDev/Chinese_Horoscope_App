...
public class UsuarioCreateDTO {
    ...
    public UsuarioCreateDTO(String nombre, String username, String email, Date fechaNacimiento, String password, String horoscopoAnimal) {
        this.nombre = nombre;
    ...
    public String getHoroscopoAnimal() {return horoscopoAnimal;}
