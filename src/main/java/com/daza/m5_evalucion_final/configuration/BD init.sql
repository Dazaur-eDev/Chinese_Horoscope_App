...
create table usuarios (
    ...
    horoscopo_animal varchar(30) not null
);

insert into usuarios (id, nombre, username, email, fecha_nacimiento, password, horoscopo_animal) values
    (1, 'Patricio', 'dazaur', 'dazaur@gmail.com', '1991-06-30', '1234', 'Cabra');

insert into horoscopo (animal, fecha_inicio, fecha_fin) values
    ('Rata', '1924-02-05', '1925-01-24'),
    ('Buey', '1925-01-25', '1926-02-13'),
    ('Tigre', '1926-02-14', '1927-02-02'),
    ('Conejo', '1927-02-03', '1928-01-22'),
    ('Dragon', '1928-01-23', '1929-02-09'),
    ('Serpiente', '1929-02-10', '1930-01-28'),
    ('Caballo', '1930-01-29', '1931-02-16'),
    ('Cabra', '1931-02-17', '1932-02-05'),
    ('Mono', '1932-02-06', '1933-01-25'),
    ('Gallo', '1933-01-26', '1934-02-13'),
    ('Perro', '1934-02-14', '1935-02-02'),
    ('Cerdo', '1935-02-03', '1936-01-23'),
    ('Rata', '1936-01-24', '1937-02-10'),
    ('Buey', '1937-02-11', '1938-01-30'),
    ('Tigre', '1938-01-31', '1939-02-18'),
    ('Conejo', '1939-02-19', '1940-02-07'),
    ('Dragon', '1940-02-08', '1941-01-26'),
    ...
    ('Perro', '1958-02-18', '1959-02-05'),
    ('Cerdo', '1959-02-06', '1960-01-26'),
    ('Rata', '1960-01-27', '1961-02-14'),
    ('Buey', '1961-02-15', '1962-02-04'),
    ('Tigre', '1962-02-05', '1963-01-24'),
    ('Conejo', '1963-01-25', '1964-02-12'),
    ('Dragon', '1964-02-13', '1965-02-01'),
